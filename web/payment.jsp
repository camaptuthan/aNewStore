<%-- 
    Document   : payment
    Created on : Jun 13, 2021, 9:55:19 AM
    Author     : admin
--%>
                    ...
                    <div class="card-body">
                        <form action="payment?totalPrice=${totalPrice}" method="POST">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="${sessionScope.user.username}" required>
                            </div>
                            <div class="form-group">
                                <label>Phone number</label>
                                <input type="text" name="phone" class="form-control" placeholder="${sessionScope.user.phonenumber}" required>
                            </div>
                            <div class="form-group">
                                <label>Address</label>
                            ...
                            <div class="form-group">
                                <label>Note</label>
                                <textarea class="form-control" rows="3" name="note" placeholder="Another opinion..."></textarea>
                            </div>
